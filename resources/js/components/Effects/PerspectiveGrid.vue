<template>
  <div class="grid-wrapper">
    <div class="grid">
      <div class="vertical">
        <div v-for="c in lines" :key="`column-${c}`" class="line"></div>
      </div>
      <div class="dots">
        <div v-for="d in dots" :key="`dot-${d}`" class="dot"></div>
      </div>
      <div class="horizontal">
        <div v-for="r in lines" :key="`row-${r}`" class="line"></div>
      </div>
    </div>
  </div>
</template>
...
.line {
  ...
  box-shadow: 0 0 7px 1px var(--v-accent-base);
...
.dot {
  ...
  &:nth-child(7) {
    left: 40%;
    animation: moveDot 18s infinite;
  }
  ...
  &:nth-child(12) {
    left: 65%;
    animation: moveDot 26s infinite;
  }
  ...
  &:nth-child(14) {
    left: 75%;
    animation: moveDot 21s infinite;
  }
  ...
  &:nth-child(17) {
    left: 90%;
    animation: moveDot 11s infinite;
  }
}
