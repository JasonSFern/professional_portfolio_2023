...
<html lang="en">
  ...
  <main>
      ...
      <div class="hero-overlay">
        <div class="hero-container d-flex flex-column justify-content-between">
          <div class="statement-container">
            <h1 class="fade-in-hero-1">INTRODUCING</h1>
            <h1 class="fade-in-hero-1">FLIGHT...</h1>
          </div>
          <div class="statement-container height-auto"></div>
          <div class="d-flex flex-row-reverse statement-container">
            <div>
              <h2 class="fade-in-hero-2">REDEFINED</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="sectionProducts">
      <div class="products-overlay">
        <div class="products-container">
          <div class="statement-container">
            <h2 class="aligncenter">OUR PRODUCTS</h2>
            <br />
            <h3 class="aligncenter">
              Three distinct choices to compliment your lifestyle
            </h3>
          </div>
        </div>
      </div>

      <section class="frosted-effect">
    ...
    <!-- UPCOMING -->
    <div id="sectionUpcoming" class="halo-overlay">
      <div class="halo-container d-flex flex-column justify-content-between">
        <div class="d-flex flex-row-reverse statement-container">
          <div>
        ...
        <div class="statement-container">
          ...
          <h1 style="font-size: 28px !important">
            Sign up for news and updates on the upcoming HALO VR-6
          </h1>
          ...
          >
            <input
              type="text"
              class="col-12 col-md-8 input-rounded"
              placeholder="Email"
            />
            <button class="col-12 col-md-4 signup-button">Sign-up</button>
          </div>
        </div>
      </div>
    </div>
